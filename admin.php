...
<body>
    ...
    <div class="container">
        ...
        <div class="col-3 col-sm-2 post-links">
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) { ?>
                            ...
                            <tr>
                                ...
                                <td class="onSmall-hide"> <?php echo number_format($row['totalCost']); ?> </td>
                                <td> <?php
                                        if ($row['marks'] < 55) {
...
<br><br>
<h3 class="titles">NOTIFIED APPLICANTS</h3>
